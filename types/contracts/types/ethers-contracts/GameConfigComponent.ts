...
export type GameConfigStruct = { creativeMode: boolean };

export type GameConfigStructOutput = [boolean] & { creativeMode: boolean };

export interface GameConfigComponentInterface extends utils.Interface {
  contractName: "GameConfigComponent";
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, GameConfigStruct]
  ): string;
  encodeFunctionData(
