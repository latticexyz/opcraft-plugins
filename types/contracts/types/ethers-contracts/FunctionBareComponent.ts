...
export type FunctionSelectorStruct = { contr: string; func: BytesLike };

export type FunctionSelectorStructOutput = [string, string] & {
  contr: string;
  func: string;
};

export interface FunctionBareComponentInterface extends utils.Interface {
  contractName: "FunctionBareComponent";
  functions: {
...
export interface FunctionBareComponent extends BaseContract {
  contractName: "FunctionBareComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FunctionBareComponentInterface;
  ...
  functions: {
    ...
    registerIndexer(arg0: string, overrides?: CallOverrides): Promise<[void]>;
    ...
    "set(uint256,(address,bytes4))"(
      entity: BigNumberish,
      value: FunctionSelectorStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
