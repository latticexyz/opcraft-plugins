...
export type ClaimStruct = { stake: BigNumberish; claimer: BigNumberish };

export type ClaimStructOutput = [number, BigNumber] & {
  stake: number;
  claimer: BigNumber;
};

export interface ClaimComponentInterface extends utils.Interface {
  contractName: "ClaimComponent";
  functions: {
...
export interface ClaimComponent extends BaseContract {
  contractName: "ClaimComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ClaimComponentInterface;
