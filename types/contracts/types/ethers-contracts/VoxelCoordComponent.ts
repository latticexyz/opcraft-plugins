...
export interface VoxelCoordComponentInterface extends utils.Interface {
  contractName: "VoxelCoordComponent";
  functions: {
...
export interface VoxelCoordComponent extends BaseContract {
  contractName: "VoxelCoordComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VoxelCoordComponentInterface;
