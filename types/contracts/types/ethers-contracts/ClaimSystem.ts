...
export interface ClaimSystemInterface extends utils.Interface {
  contractName: "ClaimSystem";
  functions: {
...
export interface ClaimSystem extends BaseContract {
  contractName: "ClaimSystem";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ClaimSystemInterface;
