...
export interface NameComponentInterface extends utils.Interface {
  contractName: "NameComponent";
  functions: {
...
export interface NameComponent extends BaseContract {
  contractName: "NameComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NameComponentInterface;
  ...
  getValue(entity: BigNumberish, overrides?: CallOverrides): Promise<string>;
