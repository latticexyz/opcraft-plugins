...
export interface Uint256BareComponentInterface extends utils.Interface {
  contractName: "Uint256BareComponent";
  functions: {
...
export interface Uint256BareComponent extends BaseContract {
  contractName: "Uint256BareComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Uint256BareComponentInterface;
