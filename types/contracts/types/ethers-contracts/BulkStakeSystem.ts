...
export interface BulkStakeSystemInterface extends utils.Interface {
  contractName: "BulkStakeSystem";
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish[], CoordStruct]
  ): string;
...
export interface BulkStakeSystem extends BaseContract {
  contractName: "BulkStakeSystem";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BulkStakeSystemInterface;
