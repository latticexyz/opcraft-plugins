...
export interface StakeComponentInterface extends utils.Interface {
  contractName: "StakeComponent";
  functions: {
...
export interface StakeComponent extends BaseContract {
  contractName: "StakeComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakeComponentInterface;
