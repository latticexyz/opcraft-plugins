...
declare function createNetworkLayer(config: GameConfig): Promise<{
  world: {
    ...
    components: import("@latticexyz/recs").Component<
      import("@latticexyz/recs").Schema,
      import("@latticexyz/recs").Metadata,
      undefined
    >[];
    registerComponent: (
      component: import("@latticexyz/recs").Component<
        import("@latticexyz/recs").Schema,
        import("@latticexyz/recs").Metadata,
        undefined
      >
  ...
  actions: {
    add: <C extends import("@latticexyz/recs").Components, T>(
      actionRequest: import("@latticexyz/std-client/dist/systems/ActionSystem/types").ActionRequest<
        C,
        T,
        {
          actionType: string;
    ...
    withOptimisticUpdates: <
      S extends import("@latticexyz/recs").Schema,
      M_1 extends import("@latticexyz/recs").Metadata,
      T_1
    >(
      component: import("@latticexyz/recs").Component<S, M_1, T_1>
    ) => import("@latticexyz/recs").OverridableComponent<S, M_1, T_1>;
  ...
  dev: {
    setContractComponentValue: <T_2 extends import("@latticexyz/recs").Schema>(
      entity: EntityIndex,
      component: import("@latticexyz/recs").Component<
        T_2,
        {
        ...
        undefined
      >,
      newValue: import("@latticexyz/recs").ComponentValue<T_2, undefined>
    ) => Promise<void>;
  ...
  relay:
    ...
    | undefined;
  worldAddress: string;
  ecsEvent$: import("rxjs").Subject<
    import("@latticexyz/network").NetworkEvent<{
      Position: import("@latticexyz/recs").Component<
        {
          x: import("@latticexyz/recs").Type.Number;
          y: import("@latticexyz/recs").Type.Number;
  ...
  faucet:
    | import("nice-grpc-web").RawClient<
        import("nice-grpc-web/lib/service-definitions/ts-proto").FromTsProtoServiceDefinition<{
          ...
          readonly methods: {
            readonly drip: {
              ...
              readonly requestType: {
                encode(
                  message: import("@latticexyz/services/protobuf/ts/faucet/faucet").DripRequest,
                  writer?: import("protobufjs").Writer | undefined
              ...
              readonly responseType: {
                encode(
                  message: import("@latticexyz/services/protobuf/ts/faucet/faucet").DripResponse,
                  writer?: import("protobufjs").Writer | undefined
                ): import("protobufjs").Writer;
                decode(
                  input: Uint8Array | import("protobufjs").Reader,
            ...
            readonly dripDev: {
              ...
              readonly requestType: {
                encode(
                  message: import("@latticexyz/services/protobuf/ts/faucet/faucet").DripDevRequest,
                  writer?: import("protobufjs").Writer | undefined
                ): import("protobufjs").Writer;
                decode(
                  input: Uint8Array | import("protobufjs").Reader,
            ...
            readonly dripVerifyTweet: {
              ...
              readonly requestType: {
                encode(
                  message: import("@latticexyz/services/protobuf/ts/faucet/faucet").DripVerifyTweetRequest,
                  writer?: import("protobufjs").Writer | undefined
                ): import("protobufjs").Writer;
                decode(
                  input: Uint8Array | import("protobufjs").Reader,
            ...
            readonly timeUntilDrip: {
              ...
              readonly responseType: {
                encode(
                  message: import("@latticexyz/services/protobuf/ts/faucet/faucet").TimeUntilDripResponse,
                  writer?: import("protobufjs").Writer | undefined
                ): import("protobufjs").Writer;
                decode(
                  input: Uint8Array | import("protobufjs").Reader,
            ...
            readonly getLinkedTwitters: {
              ...
              readonly requestType: {
                encode(
                  _: import("@latticexyz/services/protobuf/ts/faucet/faucet").GetLinkedTwittersRequest,
                  writer?: import("protobufjs").Writer | undefined
                ): import("protobufjs").Writer;
                decode(
                  input: Uint8Array | import("protobufjs").Reader,
                  length?: number | undefined
                ): import("@latticexyz/services/protobuf/ts/faucet/faucet").GetLinkedTwittersRequest;
                fromPartial(_: {}): import("@latticexyz/services/protobuf/ts/faucet/faucet").GetLinkedTwittersRequest;
              };
              readonly requestStream: false;
              readonly responseType: {
                encode(
                  message: import("@latticexyz/services/protobuf/ts/faucet/faucet").GetLinkedTwittersResponse,
                  writer?: import("protobufjs").Writer | undefined
                ): import("protobufjs").Writer;
                decode(
                  input: Uint8Array | import("protobufjs").Reader,
            ...
            readonly getLinkedTwitterForAddress: {
              ...
              readonly requestType: {
                encode(
                  message: import("@latticexyz/services/protobuf/ts/faucet/faucet").LinkedTwitterForAddressRequest,
                  writer?: import("protobufjs").Writer | undefined
                ): import("protobufjs").Writer;
                decode(
                  input: Uint8Array | import("protobufjs").Reader,
              ...
              readonly responseType: {
                encode(
                  message: import("@latticexyz/services/protobuf/ts/faucet/faucet").LinkedTwitterForAddressResponse,
                  writer?: import("protobufjs").Writer | undefined
                ): import("protobufjs").Writer;
                decode(
                  input: Uint8Array | import("protobufjs").Reader,
            ...
            readonly getLinkedAddressForTwitter: {
              ...
              readonly requestType: {
                encode(
                  message: import("@latticexyz/services/protobuf/ts/faucet/faucet").LinkedAddressForTwitterRequest,
                  writer?: import("protobufjs").Writer | undefined
                ): import("protobufjs").Writer;
                decode(
                  input: Uint8Array | import("protobufjs").Reader,
              ...
              readonly responseType: {
                encode(
                  message: import("@latticexyz/services/protobuf/ts/faucet/faucet").LinkedAddressForTwitterResponse,
                  writer?: import("protobufjs").Writer | undefined
                ): import("protobufjs").Writer;
                decode(
                  input: Uint8Array | import("protobufjs").Reader,
...
declare function createNoaLayer(network: NetworkLayer): {
  ...
  api: {
    ...
    getStakeAndClaim: (chunk: Coord) => {
      claim:
        | import("@latticexyz/recs").ComponentValue<
            {
              stake: import("@latticexyz/recs").Type.Number;
              claimer: import("@latticexyz/recs").Type.Entity;
            },
